                        ...
                        mailList.innerHTML +=
                            ...
                            onclick="displayFileContent('${file}', ${i})"> 
                                ...
                                <div class="flex flexColumn wide">
                                    ...
                                    <button style="background-color: red; color: white; margin-top: 10px; border-radius: 2px;" onclick="openThreat('${file}'); event.stopPropagation();">See threat reason</button>

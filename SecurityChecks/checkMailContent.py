...
def checkContent(mail):
    try:
        ...
        title_encodings = tokenizer(title, truncation=True, max_length=max_len, padding="max_length", return_tensors="pt")
        body_encodings = tokenizer(body, truncation=True, max_length=max_len, padding="max_length", return_tensors="pt")
